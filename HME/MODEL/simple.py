...
class SimpleModel(nn.Module):
    def __init__(
        ...
        **kwargs
        ...
        self.link_vgg_trgt = nn.Linear(self.input_ac_size, img_size)
        self.link_vgg_othr = nn.Linear(self.input_ac_size, img_size)
        ...
        self.forward_lstm = nn.Linear(self.cat_dim, self.lstm_input_dim)
